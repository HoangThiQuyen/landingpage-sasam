...
import { XCircle, Image as ImageIcon, Camera } from "react-feather";
import PerfectScrollbar from "react-perfect-scrollbar";
import "react-perfect-scrollbar/dist/css/styles.css";

// image
import avatar from "../../../public/image/avatar1.jpg";
import avatar1 from "../../../public/image/avatar2.jpg";

export default function Chat({ setShowChat, showChat }) {
  return (
    <div>
      <div
            ...
            <div className="card card-custom">
              ...
              <div className="card-header align-items-center px-4 py-3">
                ...
                <div className="text-center flex-grow-1">
                  ...
                  <div>
                    <span className="label label-dot label-success mr-1" />
                    ...
                    <div className="messages">
                        ...
                        <div className="d-flex align-items-center">
                          <div className="symbol symbol-circle symbol-40 mr-3">
                            <Image
                              alt="Pic"
                              src={avatar}
                              className="symbol symbol-circle symbol-40 "
                              width="50px"
                              height="50px"
                            />
                          </div>
                      ...
                      <div className="d-flex flex-column mb-5 align-items-end">
                        ...
                        <div className="mt-2 rounded p-5 bg-light-primary text-dark-50 font-weight-bold font-size-lg text-right max-w-400px">
                          Hey there, we re just writing to let you know that you
                          ve been subscribed to a repository on GitHub.
                        </div>
                      </div>
                      {/*end::Message Out*/}
                      {/*begin::Message In*/}
              ...
              <div className="card-footer align-items-center">
                ...
                <div className="d-flex align-items-center justify-content-between mt-5">
                  <div>
                    <ImageIcon className="mr-5 cursor-pointer text-hover-warning" />
                    <Camera className=" cursor-pointer text-hover-info" />
                  </div>
                  <div>
                    <button
                      type="button"
